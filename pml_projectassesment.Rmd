...
## Abstract
We propose an analysis of Human Activity Recognition (HAR) data about the "how well" an activity was performed. This kind of investigations potentially provides useful information for a large variety of applications, such as, for example, sport training. We finally build a machine learning based classifier with an accurancy of 99.4%.
